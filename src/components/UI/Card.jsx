...
export const Card = ({ title, img, description, technologies }) => {
    ...
    return (
        <div className="container my-5 px-4  lg:p-0 ">
            <div className="flex flex-col justify-end items-end  lg:items-start lg:place-items-end lg:grid lg:grid-rows-subgrid lg:grid-cols-2 lg:p-5">
                <h2 className='font-jura mb-5 text-2xl font-semibold text-white text-end md:text-5xl lg:text-6xl lg:row-start-1 lg:place-self-end lg:mt-10 lg:px-5'>{title}</h2>
                ...
                <p className='font-jura my-5 text-lg font-medium text-white text-end md:text-2xl lg:text-2xl lg:place-self-center lg:row-start-2 lg:my-auto lg:px-5'>
                    {description}
                </p>
                <div className="flex w-full gap-2 justify-end mb-5">
                    {
                        technologies.map(technologie =>
                            <p className='font-jura  text-lg font-light text-white text-end md:text-2xl lg:text-2xl lg:place-self-center lg:row-start-2 lg:my-auto lg:px-5'>
                                {`${technologie} / `}
                            </p>
                        )
                    }
